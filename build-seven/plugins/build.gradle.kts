...
dependencies {
    ...
    implementation(libs.android.ddms)
...
gradlePlugin {
    plugins {
        create("sevenPlugin") {
            id = "com.seven.plugin"
            implementationClass = "SevenPlugin"
        }
    }
}
...
//}
//
//val buildServiceListener: Provider<BuildListenerService> = gradle.sharedServices.registerIfAbsent(
